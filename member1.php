<?php
    session_start();
        ...
        if ( $do == 'Manage') {    //Manage Page //members // 
            ...
            // select All Users Excepts Admin
                            ...
                            echo"<td>
                                ...
                                <a href='member.php?do=Delete&userid=".$row['userID']."' class='btn btn-danger confirm'><i class='fa fa-close'></i> Delete</a>";
                                 if ($row['RegStatus']==0){
                                     ...
                                     echo "<a href='member.php?do=Activate&userid=".$row['userID']."' class='btn btn-info confirm activate'><i class='fa fa-magic'></i> Activate</a>";
             ...
             if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                //check if there's no error
                   ...
                   if (empty($formErrors)){
                    ...
                    $stmt=$con -> prepare("UPDATE users SET Email=?,Fullname=?,password=? WHERE userID =?");
